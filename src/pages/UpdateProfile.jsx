...
const UpdateProfile = () => {
    ...
    return (
        ...
        <div className="max-w-4xl w-full  shadow-2xl shadow-[#0052CC]  rounded-2xl  p-8 flex items-center justify-center gap-2" data-aos='zoom-in-left'>
                    ...
                    <form onSubmit={handleUpdate}>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className="text-black w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#0052CC]"
                            />
                        </div>
                        <div className="mb-4">
                        ...
                        <button
                            type="submit"
                            className="bg-[#0052CC] hover:bg-[#9c1631] px-4 py-2 sm:px-8 sm:py-3 rounded-3xl text-white sm:font-semibold transition-transform hover:scale-105 shadow-2xl"
                        >
                            Update Information
                        </button>
                    </form>
