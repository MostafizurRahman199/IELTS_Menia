          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-4 rounded-lg shadow-md">
              ...
              {cartCourses.map((course) => (
                <div key={course._id} className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-4">
                    <img
                      src={course.photo}
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm">{course.tags.join(", ")}</p>
              ...
              {rightServices.map((pkg) => (
                <div key={pkg._id} className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-4">
                    <div className="w-16 h-16 bg-gray-200 rounded"></div>
                    <div>
